...
public class TicTacToe {
   ...
   public static void placeMark(int theSeed) {
   ...
   public static void updateGame(int theSeed, int currentRow, int currentCol) {
      if (checkForWin(theSeed, currentRow, currentCol)) {  
   ...
   public static boolean checkForWin(int theSeed, int currentRow, int currentCol) {
